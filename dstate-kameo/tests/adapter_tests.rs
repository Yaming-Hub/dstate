//! Integration tests for the dstate-kameo adapter.
//!
...
fn kameo_11_reexports_core_types() {
    ...
    let _ = dstate_kameo::dstate::NodeId(1);
    let _config = dstate_kameo::dstate::StateConfig::default();

    // Verify adapter types are exported
    let _rt = dstate_kameo::KameoRuntime::new();
    let _events = dstate_kameo::KameoClusterEvents::new();
}
