...
use dstate::{NodeId, StateObject, StateVersion, StateViewObject};

#[test]
fn env_01_state_object_age_starts_at_0() {
    let obj = StateObject {
        version: StateVersion::new(100, 0),
        storage_version: 1,
        value: "initial",
        created_time: 1000,
        modified_time: 1000,
...
fn env_02_state_object_timestamps_set_correctly() {
    ...
    let obj = StateObject {
        version: StateVersion::new(100, 1),
        storage_version: 1,
        value: "test",
...
fn env_03_state_view_object_tracks_synced_at() {
    ...
    let view = StateViewObject {
        version: StateVersion::new(100, 5),
        wire_version: 1,
        value: "view",
        created_time: 1000,
        modified_time: 2000,
...
fn env_08_pending_remote_version_tracks_restarts() {
    let mut view = StateViewObject {
        version: StateVersion::new(1, 100),
        wire_version: 1,
        value: "stale",
        created_time: 1000,
        modified_time: 2000,
    ...
    view.pending_remote_version = Some(StateVersion::new(2, 0));
